...
public class CustomRow extends ArrayAdapter<ComplaintDetails> {
    int likes;
    List<String> likedby;
    public CustomRow(Context context, ArrayList<ComplaintDetails> arrayList){
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        ComplaintDetails currentNumberPosition = getItem(position);
        ...
        row_regno.setText(currentNumberPosition.getPhoneNumber());
