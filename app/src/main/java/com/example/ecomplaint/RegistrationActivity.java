...
//
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                ...
                                for(DataSnapshot dataSnapshot:snapshot.getChildren()){
                                    ...
                                    if(u_email.equals(check_email)){
                                        ...
                                        Complaint c= new Complaint(uniqueID,titleValue,nameValue,regnoValue,incidentInfoValue,user,"registered");
                ...
                com.example.ecomplaint.HomeFragment.arrayList.clear();
                com.example.ecomplaint.HomeFragment.adapter.notifyDataSetChanged();
                finish();
